...
export const ButtonDanger = (props) => {
    return(
    <button type="submit" className="py-2 px-4  bg-rose-600 hover:bg-rose-700 focus:ring-rose-500 focus:ring-offset-rose-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg " onClick={props.handleFunction} value={props.value}>
        {props.name}
        {props.children}
    </button>
    )
