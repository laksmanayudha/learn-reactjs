const FeaturesTwo = () => {
    ...
    <div className="relative bg-white dark:bg-gray-800 p-4">
        <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-12 lg:items-center">
            ...
            <ul className="mt-10">
                ...
                <div className="flex">
                    ...
                    <p className="mt-2 text-base leading-6 text-gray-500 dark:text-gray-300">
                        Know everything about your prefered job with your new dashboard.
                    </p>
                    </div>
                </div>
                </li>
                ...
                <div className="flex">
                    ...
                    <p className="mt-2 text-base leading-6 text-gray-500 dark:text-gray-300">
                    All the jobs you are looking for are easy to find through the multiple filters that can be applied.
                    </p>
                    </div>
                </div>
                </li>
                ...
                <div className="flex">
                    ...
                    <p className="mt-2 text-base leading-6 text-gray-500 dark:text-gray-300">
                        Apply job made easier with one click.
                    </p>
                    </div>
                </div>
                </li>
            ...
            <img src={'https://images.unsplash.com/photo-1498758536662-35b82cd15e29?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NjN8fHdvcmt8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60'} alt="illustration" className="relative mx-auto shadow-lg rounded w-auto" />
            </div>
        </div>
    </div>
    )
